...
speedSlider.addEventListener("input", () => delay = 101 - parseInt(speedSlider.value));
sizeSlider.addEventListener("input", () => !isSorting && generateArray(parseInt(sizeSlider.value)));
